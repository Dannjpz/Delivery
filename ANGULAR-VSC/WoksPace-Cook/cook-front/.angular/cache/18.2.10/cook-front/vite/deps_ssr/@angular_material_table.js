...
} from "./chunk-VLNIWZYT.js";
import {
  DOCUMENT
} from "./chunk-PN7URG7S.js";
import {
  Attribute,
...
var CdkTable = class _CdkTable {
  ...
  constructor(_differs, _changeDetectorRef, _elementRef, role, _dir, _document, _platform, _viewRepeater, _coalescedStyleScheduler, _viewportRuler, _stickyPositioningListener, _unusedNgZone) {
    ...
    this._onDestroy = new import_rxjs3.Subject();
    ...
    this.viewChange = new import_rxjs3.BehaviorSubject({
      start: 0,
...
var MatTableDataSource = class extends DataSource {
  ...
  constructor(initialData = []) {
    super();
    this._renderData = new import_rxjs4.BehaviorSubject([]);
    this._filter = new import_rxjs4.BehaviorSubject("");
    this._internalPageChanges = new import_rxjs4.Subject();
